      ...
      <Grid container spacing={2} mt={2}>
        <Grid item md={6} sm={12}>
          ...
          <Typography variant="body1">
            ...
            products are manufactured to your specifications by highly qualified
            production staff. R&P is dedicated to providing each customer with
            only the highest quality of service and products.
          </Typography>
        </Grid>
        <Grid item md={6} sm={12}>
          <SlideShow />
